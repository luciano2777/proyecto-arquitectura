...
String API_Key = "661e99138f15417294a56a7d3a03584b"; // Enter a 32 digit API
int httpCode;
String payload;
String menu;
int pagina=0;
...
void setup()
{
  ...
  display.print("Gianfranco Mongiello");   // To make it intresting, you an change the name, and make your own. 
  display.setCursor(0, 48);
  display.print("Luciano Ruiz");   // To make it intresting, you an change the name, and make your own. 
   ...
   if (WiFi.status() == WL_CONNECTED)
  {
    ...
    http.begin(client,"http://newsapi.org/v2/top-headlines?country=ve&pageSize=10&apiKey=" + API_Key);
    httpCode = http.GET();
    ...
    if (httpCode > 0)
    {
      ...
      display.print("Noticias de Venezuela");
      display.display();
      delay(4000);
